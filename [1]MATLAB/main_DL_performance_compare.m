...
testPath = fullfile('C:\Users\HYPC300\OneDrive - 한양대학교\GitHub\Deeplearning-Autoencoder-DOA\data\result',basePath,'test_data.mat'); % WINDOWS PATH:
...
%%
labelPath = fullfile('C:\Users\HYPC300\OneDrive - 한양대학교\GitHub\Deeplearning-Autoencoder-DOA\data\result',basePath,'test_label.mat'); % WINDOWS PATH:
...
%     [P_MUSIC_ori] = MUSIC_DOA(Rxx_noisy_test(:, :, i), M0, lambda, angle_scan, K);
    ...
    plot(angle_scan, 10 * log10(P_MUSIC_ori / max(P_MUSIC_ori)), 'Linewidth', 1);
       msg = num2str(60);
    xline(60, '--r', msg, 'LabelOrientation', 'horizontal', ...
