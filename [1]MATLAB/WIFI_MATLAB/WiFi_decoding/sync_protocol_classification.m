...
%% wlan waveform
cfgVHT = wlanVHTConfig('ChannelBandwidth','CBW20','MCS',0); % bpsk 1/2 data 
cfgHT = wlanHTConfig('ChannelBandwidth','CBW20','MCS',0); % bpsk 1/2 data 
cfgnonHT = wlanNonHTConfig('ChannelBandwidth','CBW20','MCS',0); % bpsk 1/2 data 
...
%                 tgacChan = wlanTGacChannel('SampleRate',20e6,'ChannelBandwidth','CBW20','DelayProfile','Model-E','LargeScaleFadingEffect','Pathloss and shadowing');
        ...
        rxSig_VHT = chNoise(tgacChan(wholeWaveform_VHT));  
        
        % wholeWaveform_scaling  wholeWaveform
