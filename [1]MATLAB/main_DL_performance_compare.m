...
M0 = 20; % Total number of antenna elements # RF:test 8 # matlab 20
nsnapshot = 100;
...
elseif isequal(operSys,'UBUNTU')
    dataPath = '/home/hymc/[0]Github/Deeplearning-Autoencoder-DOA/[2]Tensorflow/[1]DAE_DOA_implementation/result/random_single source_100snapshots_1000sample/denoised_data.mat'; % UBUNTU PATH: 
else
